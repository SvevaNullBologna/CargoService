...
class Webguimock ( name: String, scope: CoroutineScope, isconfined: Boolean=false, isdynamic: Boolean=false ) : 
		...
		return { //this:ActionBasciFsm
				...
				state("waitforupdate") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t026",targetState="updategui",cond=whenDispatch("update"))
				}	 
