		...
		return { //this:ActionBasciFsm
				...
				state("waitForCommand") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t010",targetState="executeCommand",cond=whenDispatch("command"))
				}	 
				state("executeCommand") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition( edgeName="goto",targetState="waitToFinish", cond=doswitch() )
				}	 
				state("waitToFinish") { //this:State
					action { //it:State
						CommUtils.outblack("waiting to finish")
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
					sysaction { //it:State
					}	 	 
					 transition(edgeName="t111",targetState="waitForCommand",cond=whenEvent("finishedtransport"))
				}	 
			}
		}
} 
