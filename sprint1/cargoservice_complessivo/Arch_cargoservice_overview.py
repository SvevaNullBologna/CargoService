...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     sys >> Edge( label='anomalyFixed', **evattr, decorate='true', fontcolor='darkgreen') >> cargoservice
     sys >> Edge( label='finishedtransport', **evattr, decorate='true', fontcolor='darkgreen') >> cargorobot
