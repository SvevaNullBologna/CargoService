...
class Listener ( name: String, scope: CoroutineScope, isconfined: Boolean=false, isdynamic: Boolean=false ) : 
		...
		return { //this:ActionBasciFsm
				...
				state("readSonarData") { //this:State
					action { //it:State
						...
						if( Distance > 0  
						 ){CommUtils.outgreen("readsonardata : $data")
